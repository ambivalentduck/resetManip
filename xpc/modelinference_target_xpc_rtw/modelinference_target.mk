...
MODEL           = modelinference_target
MODULES         = modelinference_target_capi.c modelinference_target_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_mod_snf.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = modelinference_target.mk
...
S_FUNCTIONS     = danipcie.c xpcudpbytesend.c dipci8255.c dopci8255.c adnipcie.c xpcionie.c
S_FUNCTIONS_LIB = 
NUMST           = 5
TID01EQ         = 1
NCSTATES        = 14
...
MODELLIB                  = modelinference_targetlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Justin\Desktop\ProjectFiles\BasicCompensator\modelinference_target_xpc_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Justin\Desktop\ProjectFiles\BasicCompensator
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Justin\Desktop\ProjectFiles\ModelInference
