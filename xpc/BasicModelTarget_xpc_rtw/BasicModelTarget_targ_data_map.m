  ...
  ;%***********************
    ...
    ;%
      section.nData     = 274;
      section.data(274)  = dumData; %prealloc
	  ...
	  ;% BasicModelTarget_P.Gain2_Gain_h
	  ...
	  ;% BasicModelTarget_P.Gain3_Gain_g
	  ...
	  section.data(72).dtTransOffset = 146;
	  ...
	  section.data(82).dtTransOffset = 164;
	  ...
	  section.data(88).dtTransOffset = 182;
	  ...
	  section.data(110).dtTransOffset = 219;
	  ...
	  section.data(116).dtTransOffset = 231;
	  ...
	  section.data(119).dtTransOffset = 235;
	  ...
	  section.data(122).dtTransOffset = 240;
	
	  ;% BasicModelTarget_P.Bit1_P8_Size
	  section.data(123).logicalSrcIdx = 130;
	  section.data(123).dtTransOffset = 241;
	  ...
	  section.data(126).dtTransOffset = 246;
	  ...
	  section.data(185).dtTransOffset = 359;
	  ...
	  section.data(189).dtTransOffset = 375;
	
	  ;% BasicModelTarget_P.PCI6031EAD_P4
	  section.data(190).logicalSrcIdx = 197;
	  section.data(190).dtTransOffset = 377;
	  ...
	  section.data(200).dtTransOffset = 393;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% BasicModelTarget_B.TmpSignalConversionAtDotProdu_o
	  ...
	  ;% BasicModelTarget_B.Smallviscousityperpendiculartor
	  ...
	  section.data(70).dtTransOffset = 113;
	  ...
	  section.data(123).dtTransOffset = 185;
	
	  ;% BasicModelTarget_B.Derivative4
	  section.data(124).logicalSrcIdx = 123;
	  section.data(124).dtTransOffset = 186;
	  ...
	  section.data(127).dtTransOffset = 189;
	
	  ;% BasicModelTarget_B.TmpSignalConversionAtMatrixMult
	  section.data(128).logicalSrcIdx = 127;
	  section.data(128).dtTransOffset = 190;
	
	  ;% BasicModelTarget_B.MatrixMultiply
	  section.data(129).logicalSrcIdx = 128;
	  section.data(129).dtTransOffset = 192;
	  ...
	  section.data(133).dtTransOffset = 203;
	
	  ;% BasicModelTarget_B.Gain2_e
	  section.data(134).logicalSrcIdx = 133;
	  section.data(134).dtTransOffset = 204;
	
	  ;% BasicModelTarget_B.Gain3_g
	  section.data(135).logicalSrcIdx = 134;
	  section.data(135).dtTransOffset = 208;
	  ...
	  section.data(141).dtTransOffset = 222;
	
	  ;% BasicModelTarget_B.Saturation2
	  section.data(142).logicalSrcIdx = 141;
	  section.data(142).dtTransOffset = 224;
	
	  ;% BasicModelTarget_B.Product2_o
	  section.data(143).logicalSrcIdx = 142;
	  section.data(143).dtTransOffset = 225;
	  ...
	  section.data(146).dtTransOffset = 228;
	
	  ;% BasicModelTarget_B.Product3_a
	  section.data(147).logicalSrcIdx = 146;
	  section.data(147).dtTransOffset = 229;
	
	  ;% BasicModelTarget_B.RESET
	  section.data(148).logicalSrcIdx = 147;
	  section.data(148).dtTransOffset = 230;
	
	  ;% BasicModelTarget_B.Sum_o
	  section.data(149).logicalSrcIdx = 148;
	  section.data(149).dtTransOffset = 231;
	
	  ;% BasicModelTarget_B.ZeroOrderHold1
	  section.data(150).logicalSrcIdx = 149;
	  section.data(150).dtTransOffset = 232;
	
	  ;% BasicModelTarget_B.SGain
	  section.data(151).logicalSrcIdx = 150;
	  section.data(151).dtTransOffset = 233;
	
	  ;% BasicModelTarget_B.Integrator
	  section.data(152).logicalSrcIdx = 151;
	  section.data(152).dtTransOffset = 234;
	  ...
	  section.data(154).dtTransOffset = 236;
	
	  ;% BasicModelTarget_B.Integrator_g
	  section.data(155).logicalSrcIdx = 154;
	  section.data(155).dtTransOffset = 237;
	
	  ;% BasicModelTarget_B.Saturation
	  section.data(156).logicalSrcIdx = 155;
	  section.data(156).dtTransOffset = 238;
	
	  ;% BasicModelTarget_B.SGain4
	  section.data(157).logicalSrcIdx = 156;
	  section.data(157).dtTransOffset = 239;
	
	  ;% BasicModelTarget_B.Bit1_o1
	  section.data(158).logicalSrcIdx = 157;
	  section.data(158).dtTransOffset = 240;
	
	  ;% BasicModelTarget_B.Bit1_o2
	  section.data(159).logicalSrcIdx = 158;
	  section.data(159).dtTransOffset = 241;
	
	  ;% BasicModelTarget_B.Bits181_o1
	  section.data(160).logicalSrcIdx = 159;
	  section.data(160).dtTransOffset = 242;
	
	  ;% BasicModelTarget_B.Bits181_o2
	  section.data(161).logicalSrcIdx = 160;
	  section.data(161).dtTransOffset = 243;
	
	  ;% BasicModelTarget_B.Bits181_o3
	  section.data(162).logicalSrcIdx = 161;
	  section.data(162).dtTransOffset = 244;
	
	  ;% BasicModelTarget_B.Bits181_o4
	  section.data(163).logicalSrcIdx = 162;
	  section.data(163).dtTransOffset = 245;
	
	  ;% BasicModelTarget_B.Bits181_o5
	  section.data(164).logicalSrcIdx = 163;
	  section.data(164).dtTransOffset = 246;
	
	  ;% BasicModelTarget_B.Bits181_o6
	  section.data(165).logicalSrcIdx = 164;
	  section.data(165).dtTransOffset = 247;
	
	  ;% BasicModelTarget_B.Bits181_o7
	  section.data(166).logicalSrcIdx = 165;
	  section.data(166).dtTransOffset = 248;
	
	  ;% BasicModelTarget_B.Bits181_o8
	  section.data(167).logicalSrcIdx = 166;
	  section.data(167).dtTransOffset = 249;
	
	  ;% BasicModelTarget_B.Bits91_o1
	  section.data(168).logicalSrcIdx = 167;
	  section.data(168).dtTransOffset = 250;
	
	  ;% BasicModelTarget_B.Bits91_o2
	  section.data(169).logicalSrcIdx = 168;
	  section.data(169).dtTransOffset = 251;
	
	  ;% BasicModelTarget_B.Bits91_o3
	  section.data(170).logicalSrcIdx = 169;
	  section.data(170).dtTransOffset = 252;
	  ...
	  section.data(174).dtTransOffset = 256;
	
	  ;% BasicModelTarget_B.Bits91_o8
	  section.data(175).logicalSrcIdx = 174;
	  section.data(175).dtTransOffset = 257;
	
	  ;% BasicModelTarget_B.Sum_ga
	  section.data(176).logicalSrcIdx = 175;
	  section.data(176).dtTransOffset = 258;
	
	  ;% BasicModelTarget_B.MathFunction
	  section.data(177).logicalSrcIdx = 176;
	  section.data(177).dtTransOffset = 259;
	
	  ;% BasicModelTarget_B.PulseGenerator1
	  section.data(178).logicalSrcIdx = 177;
	  section.data(178).dtTransOffset = 260;
	
	  ;% BasicModelTarget_B.PCI6031EAD_o1
	  section.data(179).logicalSrcIdx = 178;
	  section.data(179).dtTransOffset = 261;
	
	  ;% BasicModelTarget_B.PCI6031EAD_o2
	  section.data(180).logicalSrcIdx = 179;
	  section.data(180).dtTransOffset = 262;
	
	  ;% BasicModelTarget_B.PCI6031EAD_o3
	  section.data(181).logicalSrcIdx = 180;
	  section.data(181).dtTransOffset = 263;
	
	  ;% BasicModelTarget_B.PCI6031EAD_o4
	  section.data(182).logicalSrcIdx = 181;
	  section.data(182).dtTransOffset = 264;
	
	  ;% BasicModelTarget_B.PCI6031EAD_o5
	  section.data(183).logicalSrcIdx = 182;
	  section.data(183).dtTransOffset = 265;
	
	  ;% BasicModelTarget_B.PCI6031EAD_o6
	  section.data(184).logicalSrcIdx = 183;
	  section.data(184).dtTransOffset = 266;
	
	  ;% BasicModelTarget_B.Bit17_o1
	  section.data(185).logicalSrcIdx = 184;
	  section.data(185).dtTransOffset = 267;
	
	  ;% BasicModelTarget_B.Bit17_o2
	  section.data(186).logicalSrcIdx = 185;
	  section.data(186).dtTransOffset = 268;
	
	  ;% BasicModelTarget_B.Bits18_o1
	  section.data(187).logicalSrcIdx = 186;
	  section.data(187).dtTransOffset = 269;
	
	  ;% BasicModelTarget_B.Bits18_o2
	  section.data(188).logicalSrcIdx = 187;
	  section.data(188).dtTransOffset = 270;
	
	  ;% BasicModelTarget_B.Bits18_o3
	  section.data(189).logicalSrcIdx = 188;
	  section.data(189).dtTransOffset = 271;
	
	  ;% BasicModelTarget_B.Bits18_o4
	  section.data(190).logicalSrcIdx = 189;
	  section.data(190).dtTransOffset = 272;
	
	  ;% BasicModelTarget_B.Bits18_o5
	  section.data(191).logicalSrcIdx = 190;
	  section.data(191).dtTransOffset = 273;
	
	  ;% BasicModelTarget_B.Bits18_o6
	  section.data(192).logicalSrcIdx = 191;
	  section.data(192).dtTransOffset = 274;
	
	  ;% BasicModelTarget_B.Bits18_o7
	  section.data(193).logicalSrcIdx = 192;
	  section.data(193).dtTransOffset = 275;
	
	  ;% BasicModelTarget_B.Bits18_o8
	  section.data(194).logicalSrcIdx = 193;
	  section.data(194).dtTransOffset = 276;
	
	  ;% BasicModelTarget_B.Bits916_o1
	  section.data(195).logicalSrcIdx = 194;
	  section.data(195).dtTransOffset = 277;
	
	  ;% BasicModelTarget_B.Bits916_o2
	  section.data(196).logicalSrcIdx = 195;
	  section.data(196).dtTransOffset = 278;
	
	  ;% BasicModelTarget_B.Bits916_o3
	  section.data(197).logicalSrcIdx = 196;
	  section.data(197).dtTransOffset = 279;
	
	  ;% BasicModelTarget_B.Bits916_o4
	  section.data(198).logicalSrcIdx = 197;
	  section.data(198).dtTransOffset = 280;
	
	  ;% BasicModelTarget_B.Bits916_o5
	  section.data(199).logicalSrcIdx = 198;
	  section.data(199).dtTransOffset = 281;
	
	  ;% BasicModelTarget_B.Bits916_o6
	  section.data(200).logicalSrcIdx = 199;
	  section.data(200).dtTransOffset = 282;
	
	  ;% BasicModelTarget_B.Bits916_o7
	  section.data(201).logicalSrcIdx = 200;
	  section.data(201).dtTransOffset = 283;
	
	  ;% BasicModelTarget_B.Bits916_o8
	  section.data(202).logicalSrcIdx = 201;
	  section.data(202).dtTransOffset = 284;
	
	  ;% BasicModelTarget_B.Sum_d
	  section.data(203).logicalSrcIdx = 202;
	  section.data(203).dtTransOffset = 285;
	  ...
	  section.data(206).dtTransOffset = 288;
	  ...
	  section.data(210).dtTransOffset = 292;
	  ...
	  section.data(4).dtTransOffset = 208;
  ...
  targMap.checksum0 = 3340799056;
  targMap.checksum1 = 51169223;
  targMap.checksum2 = 2356541911;
  targMap.checksum3 = 1902379768;
