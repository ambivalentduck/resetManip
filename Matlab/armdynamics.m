function [dx, p_real, v_real, a_real,f_handle]=armdynamics(t,x)

global kd kp l1 lc1 lc2 m1 m2 I1 I2 coeffFF coeffFB pf Jt fJ getAlpha getAccel tKick curlMag magKick durKick
...
F=((t>tKick)&&(t<(tKick+durKick)))*magKick*(pf-p_real); %kick is towards target
rot=-pi/2;
F=[cos(rot), -sin(rot);sin(rot), cos(rot)]*F; %Don't kick straight towards
F=F +(t<tKick)*[curlMag 0; 0 -curlMag]*v_real; %add curl
